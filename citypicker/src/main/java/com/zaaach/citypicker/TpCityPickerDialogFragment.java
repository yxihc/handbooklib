 ...
 * @Date: 2018/2/6 20:50
 */
public class TpCityPickerDialogFragment extends DialogFragment implements TextWatcher,
...
//    private ImageView mClearAllBtn;
     ...
     * @return
     */
    public static TpCityPickerDialogFragment newInstance(boolean enable) {
        final TpCityPickerDialogFragment fragment = new TpCityPickerDialogFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mContentView = inflater.inflate(R.layout.tp_cp_dialog_city_picker, container, false);
        return mContentView;
    }
...
//        mClearAllBtn.setOnClickListener(this);
    ...
    private void initData() {
        ...
        mAllCities.add(1, new HotCity("已开通城市", "未知", "0"));
        mResults = mAllCities;
    }
