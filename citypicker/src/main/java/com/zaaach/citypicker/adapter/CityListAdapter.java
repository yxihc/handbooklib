...
//    : Cannot call this method while RecyclerView is computing a layout or scrolling android.support.v7.widget.RecyclerView{655fc13 VFED..... ......ID 0,0-1080,1866 #7f0800ae app:id/cp_city_recyclerview}, adapter:com.zaaach.citypicker.adapter.CityListAdapter@f1c4e50, layout:android.support.v7.widget.LinearLayoutManager@c9e849, context:cn.com.hele.babytalk.patient.module.login.ui.activity.TpCityPickerActivity@e229dbe
...
//    at com.zaaach.citypicker.adapter.CityListAdapter.refreshLocationItem(CityListAdapter.java:76)
//    at com.zaaach.citypicker.adapter.CityListAdapter.updateLocateState(CityListAdapter.java:69)
//    at cn.com.hele.babytalk.patient.module.login.ui.activity.TpCityPickerActivity.locationChanged(TpCityPickerActivity.java:221)
//    at cn.com.hele.babytalk.patient.module.login.ui.activity.TpCityPickerActivity$4.onReceiveLocation(TpCityPickerActivity.java:430)
//    at com.baidu.location.LocationClient.sendFirstLoc(Unknown Source:42)
//    at com.baidu.location.LocationClient.access$3000(Unknown Source:0)
//    at com.baidu.location.LocationClient$a.handleMessage(Unknown Source:151)
