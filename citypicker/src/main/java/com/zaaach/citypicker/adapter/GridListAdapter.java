...
public class GridListAdapter extends RecyclerView.Adapter<GridListAdapter.GridViewHolder> {
    ...
    public void onBindViewHolder(GridViewHolder holder, int position) {
        ...
        if (data.isChoose()) {
            holder.name.setBackgroundResource(R.drawable.tv_check_yes);
            holder.name.setTextColor(Color.parseColor("#ffff6688"));
        } else {
            holder.name.setBackgroundResource(R.drawable.tv_check_no);
