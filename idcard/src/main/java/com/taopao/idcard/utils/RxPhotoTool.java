package com.taopao.idcard.utils;
...
public class RxPhotoTool {
    ...
    public static void openLocalImage(final Activity activity) {
        ...
        activity.startActivityForResult(pickIntent, GET_IMAGE_FROM_PHONE);
    ...
    public static void openLocalImage(final Fragment fragment) {
        ...
        // 如果限制上传到服务器的图片类型时可以直接写如："image/jpeg 、 image/png等的类型"
        pickIntent.setDataAndType(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, "image/*");
        fragment.startActivityForResult(pickIntent, GET_IMAGE_FROM_PHONE);
    }
