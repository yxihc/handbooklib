package com.taopao.verificationinput;
...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        contentTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_contentTextSize, sp2px(14));

        collapseExpandTextColor = typedArray.getColor(R.styleable.ExpandableTextView_collapseExpandTextColor, ContextCompat.getColor(getContext(), R.color.text_qw));
        collapseExpandTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_collapseExpandTextSize, sp2px(14));
    ...
    private void findViews() {
        ...
        mTvExpandCollapse.setOnClickListener(this);
//        mTvContent.setLineSpacing(1.2f, 1.2f);
...
//        float line = lineSpacingMultiplier * (lineCount - 1);
//        textHeight = (int) (textHeight + line);
