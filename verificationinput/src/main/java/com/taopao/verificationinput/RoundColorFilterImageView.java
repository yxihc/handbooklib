...
public class RoundColorFilterImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.RoundColorFilterImageView);
        roundWidth = typedArray.getInt(R.styleable.RoundColorFilterImageView_tp_round, roundWidth);
